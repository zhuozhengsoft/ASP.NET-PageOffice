...
打开文件”，看并发控制效果。</span><br /><br />
        1：<a href="javascript:POBrowser.openWindowModeless('Word.aspx?userid=1' , 'width=1200px;height=800px;');" >张三打开文件</a><br /><br />
        2：<a href="javascript:POBrowser.openWindowModeless('Word.aspx?userid=2' , 'width=1200px;height=800px;');" >李四打开文件</a>
        </div>
